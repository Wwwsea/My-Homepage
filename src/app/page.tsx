  ...
  return (
    <>
      <Container className="mt-9">
        ...
        <div className="mt-6 border-t border-zinc-100 py-2 dark:border-zinc-700/40">
          <div className="w-full overflow-hidden">
            <div className="dark:hidden">
              <img src="/github-contribution-snake/github-contribution-grid-snake.svg" alt="github-contribution" />
              </div>
              <div className="hidden dark:block">
                <img src="/github-contribution-snake/github-contribution-grid-snake-dark.svg" alt="github-contribution" />
              </div>
            </div>
          </div>
